    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            if(pilihan==1){
                ...
                System.out.println(bus.NaikPenumpang(pen) ? "Penumpang Telah Ditambahkan":"Penumpang Gagal ditambahkan!");
            }else if(pilihan==2){
                System.out.print("Nama : ");
                nama = input.nextLine();
                System.out.println(bus.turunkanPenumpang(nama) ? "Penumpang Telah Turun!":"Penumpang Tidak ditemukan!");
            }else if(pilihan==3){
